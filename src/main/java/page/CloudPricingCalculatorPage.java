...
public class CloudPricingCalculatorPage extends AbstractPage {
    ...
    public CloudPricingCalculatorPage selectDatacenterLocation() {
        WebElement datacenterDropDown = waitElementToBeClickable(driver,DATACENTER_LOCATION_DROPDOWN);
    ...
    public CloudPricingCalculatorPage selectCommittedUsage() {
        ...
        WebElement committedUsageValue = waitElementToBeClickable(driver,committedUsageValueLocator);
